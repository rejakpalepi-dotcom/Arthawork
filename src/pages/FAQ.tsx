...
export default function FAQ() {
    ...
    // Add FAQPage structured data for Google rich results
    useEffect(() => {
        const faqSchema = {
    ...
    return (
        <>
            <SEOHead
                ...
                description="Temukan jawaban untuk pertanyaan yang sering diajukan tentang Artha. Cara membuat invoice, proposal, metode pembayaran, dan keamanan."
                canonical="https://arthawork.vercel.app/faq"
            />
