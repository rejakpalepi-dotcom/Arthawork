...
const pricingTiers = [
    {
        ...
        features: ["3 invoice/bulan", "1 proposal/bulan", "5 klien maksimal"],
        cta: "Mulai Gratis",
        popular: false,
    },
    {
        ...
        features: ["Invoice unlimited", "Proposal unlimited", "Klien unlimited", "Prioritas support"],
        cta: "Pilih Pro",
        popular: true,
    },
    {
        ...
        features: ["Semua fitur Pro", "5 anggota tim", "Laporan analytics", "Custom branding"],
        cta: "Pilih Business",
        popular: false,
    },
];
