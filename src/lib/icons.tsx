/**
 * Artha Custom Icon Library
 * Professional outline-style icons (Linear-inspired)
 * Replacing Lucide icons to avoid "vibe coding" appearance
 */
...
export function InvoiceIcon({ className, strokeWidth = 1.5 }: IconProps) {
    return (
        <svg
...
export function ProposalIcon({ className, strokeWidth = 1.5 }: IconProps) {
    return (
        <svg
            className={cn("w-6 h-6", className)}
            viewBox="0 0 24 24"
...
// Clients/Users Icon
export function ClientsIcon({ className, strokeWidth = 1.5 }: IconProps) {
    return (
        <svg
            className={cn("w-6 h-6", className)}
            viewBox="0 0 24 24"
...
// Phone/Mobile Icon
export function MobileIcon({ className, strokeWidth = 1.5 }: IconProps) {
    return (
        <svg
            className={cn("w-6 h-6", className)}
            viewBox="0 0 24 24"
...
// Trending Up Icon
export function TrendingUpIcon({ className, strokeWidth = 1.5 }: IconProps) {
    return (
        <svg
            className={cn("w-6 h-6", className)}
            viewBox="0 0 24 24"
...
// Target Icon
export function TargetIcon({ className, strokeWidth = 1.5 }: IconProps) {
    return (
        <svg
            className={cn("w-6 h-6", className)}
            viewBox="0 0 24 24"
...
// Chevron Up Icon
export function ChevronUpIcon({ className, strokeWidth = 1.5 }: IconProps) {
    return (
        <svg
            className={cn("w-6 h-6", className)}
            viewBox="0 0 24 24"
...
// Credit Card Icon
export function CreditCardIcon({ className, strokeWidth = 1.5 }: IconProps) {
    return (
        <svg
            className={cn("w-6 h-6", className)}
            viewBox="0 0 24 24"
...
// Folder Icon
export function FolderIcon({ className, strokeWidth = 1.5 }: IconProps) {
    return (
        <svg
            className={cn("w-6 h-6", className)}
            viewBox="0 0 24 24"
...
export function ContractIcon({ className, strokeWidth = 1.5 }: IconProps) {
    return (
        <svg
            className={cn("w-6 h-6", className)}
            viewBox="0 0 24 24"
...
// Tax/Calculator Icon
export function TaxIcon({ className, strokeWidth = 1.5 }: IconProps) {
    return (
        <svg
            className={cn("w-6 h-6", className)}
            viewBox="0 0 24 24"
...
export function ServicesIcon({ className, strokeWidth = 1.5 }: IconProps) {
    return (
        <svg
            className={cn("w-6 h-6", className)}
            viewBox="0 0 24 24"
...
export function MoreHorizontalIcon({ className, strokeWidth = 1.5 }: IconProps) {
    return (
        <svg
            className={cn("w-6 h-6", className)}
            viewBox="0 0 24 24"
...
// File/Document Icon (for PDF)
export function FileIcon({ className, strokeWidth = 1.5 }: IconProps) {
    return (
        <svg
            className={cn("w-6 h-6", className)}
            viewBox="0 0 24 24"
