      ...
      <div className="flex-1 flex flex-col justify-center px-6 pt-4 relative z-10">
        <div className="space-y-4">
          <div className="space-y-3">
            <div className="text-[#00ACC1] text-[9px] font-semibold tracking-[0.2em] uppercase">Project Proposal</div>
...
function IntroPreview({ data }: { data: ProposalData }) {
  return (
    <div className="h-full bg-white flex flex-col font-sans">
      ...
      {/* Footer */}
      <div className="px-6 py-3 border-t border-gray-100 flex items-center justify-between text-[8px] text-gray-400 font-normal"></div>
    </div>
  );
}
  ...
  return (
    <div className="h-full bg-white flex flex-col font-sans">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 min-h-0">
        <h2 className="text-xl font-black text-[#1a1a1a] mb-2 leading-tight uppercase">{data.experienceTitle}</h2>
                ...
                <div className="flex items-start justify-between gap-2">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      {service.description && (
                        <p className="text-[9px] text-gray-500 mt-0.5 line-clamp-2 font-normal">
                          {service.description}
                        </p>
                      )}
                    </div>
...
function InvestmentPreview({ data }: { data: ProposalData }) {
  ...
  return (
    <div className="h-full bg-[#1a1a1a] text-white flex flex-col font-sans">
      ...
      {/* Footer */}
      <div className="px-6 py-3 border-t border-white/10 flex items-center justify-between text-[8px] text-gray-500 font-normal"></div>
    </div>
  );
}
